        ...
        <div class="">
            <div class="hero__slider owl-carousel">
                @foreach ($heros as $hero)
                    <div class="hero__items set-bg" data-setbg="{{ asset("assets/img/hero/$hero->image") }}">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="hero__text">
                                    <div class="label">{{ $hero->genere }}</div>
                                    <h2>{{ $hero->name }}</h2>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg"
                                            data-setbg="{{ asset('assets/img/trending/trend-1.jpg') }}">
